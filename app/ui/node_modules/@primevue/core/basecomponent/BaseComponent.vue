...
import { showInvalidLicenseBanner } from '@primevue/core/license/licenseBanner';
...
export default {
    ...
    mounted() {
        ...
        if (!this.$primevue || this.$primevue.verified?.value === false) {
    ...
    methods: {
        ...
        _loadScopedThemeStyles(preset) {
            if (this.$theme?.options?.cssVariables === false && this.$style?.name) {
