...
var p$1 = {
	...
	menuSub: {
		...
		gap: "0.125rem",
		indentMargin: "1rem",
		indentPadding: "0.75rem",
		collapsibleIndent: "1.75rem",
...
//#endregion
//#region node_modules/@primeuix/themes/dist/lara-compat/index.mjs
...
var Zm;
var $m = (Zm = ((m, r) => {
	for (var e in r || (r = {})) a.call(r, e) && i(m, e, r[e]);
	if (t) for (var e of t(r)) o.call(r, e) && i(m, e, r[e]);
	return m;
})({}, a$45), r(Zm, e({ components: {
	accordion: c$22,
	autocomplete: s$14,
	avatar: n$41,
	badge: l$18,
