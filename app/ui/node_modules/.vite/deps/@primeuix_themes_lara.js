...
var a$45 = {
	...
	semantic: {
		...
		list: {
			padding: "0.5rem 0",
			gap: "0",
			header: { padding: "0.5rem 0.875rem 0 0.875rem" },
			option: {
...
var o$88 = { root: { borderRadius: "{content.border.radius}" } };
var n$39 = {
	root: {
		padding: "1.125rem",
		background: "{content.background}",
...
var k$1 = {
	...
	header: {
		...
		lg: { padding: "0.875rem 1.125rem" }
	},
	headerCell: {
		background: "light-dark({surface.50}, {surface.800})",
		hoverBackground: "light-dark({surface.100}, {surface.700})",
		selectedBackground: "light-dark({surface.50}, {surface.800})",
		borderColor: "{datatable.border.color}",
		color: "{text.color}",
...
var k = {
	...
	monthView: { margin: "0.625rem 0 0 0" },
	month: {
		padding: "0.5rem",
		borderRadius: "{content.border.radius}"
	},
	yearView: { margin: "0.625rem 0 0 0" },
	year: {
		padding: "0.5rem",
		borderRadius: "{content.border.radius}"
	},
...
var l$11 = {
	...
	thumbnailNavButtonIcon: { size: "0.875rem" },
	caption: {
	...
	closeButtonIcon: { size: "1.25rem" }
};
var s$8 = {
	backdrop: { background: "{surface.950}" },
	header: {
	...
	thumbnailContent: { padding: "0.25rem 0" }
};
var r$58 = { icon: { color: "{form.field.icon.color}" } };
var i$25 = {
	root: {
		color: "{form.field.float.label.color}",
		focusColor: "{form.field.float.label.focus.color}",
...
var a$29 = {
	root: { borderColor: "{content.border.color}" },
	area: { borderRadius: "{content.border.radius}" },
	slider: {
		borderRadius: "{content.border.radius}",
		size: "1rem"
	},
...
var d$20 = {
	...
	item: { borderRadius: "{form.field.border.radius}" }
};
var d$19 = { root: {
	fontSize: "{form.field.font.size}",
	fontWeight: "{form.field.font.weight}",
...
var b$3 = {
	...
	content: {
		padding: "0.625rem 0.875rem",
		gap: "0.5rem",
		sm: { padding: "0.5rem 0.5rem" },
		lg: { padding: "0.625rem 0.75rem" }
	},
	text: {
		fontSize: "0.875rem",
		fontWeight: "500",
	...
	info: {
		...
		simple: { color: "light-dark({blue.600}, {blue.500})" }
	},
	success: {
		background: "light-dark(color-mix(in srgb, {green.50}, transparent 5%), color-mix(in srgb, {green.500}, transparent 84%))",
		borderColor: "transparent",
		...
		simple: { color: "light-dark({green.600}, {green.500})" }
	},
	warn: {
		background: "light-dark(color-mix(in srgb,{yellow.50}, transparent 5%), color-mix(in srgb, {yellow.500}, transparent 84%))",
		borderColor: "transparent",
		...
		simple: { color: "light-dark({yellow.600}, {yellow.500})" }
	},
	error: {
		background: "light-dark(color-mix(in srgb, {red.50}, transparent 5%), color-mix(in srgb, {red.500}, transparent 84%))",
		borderColor: "transparent",
		...
		simple: { color: "light-dark({red.600}, {red.500})" }
	},
	secondary: {
		background: "light-dark({surface.100}, {surface.800})",
		borderColor: "transparent",
		...
		simple: { color: "light-dark({surface.500}, {surface.400})" }
	},
	contrast: {
		background: "light-dark({surface.900}, {surface.0})",
		borderColor: "transparent",
		...
		simple: { color: "light-dark({surface.900}, {surface.0})" }
	}
};
var n$19 = {
	root: {
...
var n$16 = {
	...
	jumpToPageInput: { maxWidth: "2.25rem" }
};
var a$20 = {
	root: {
		background: "{content.background}",
	...
	toggleableHeader: { padding: "0.25rem 1rem" },
	title: {
		fontWeight: "700",
		fontSize: "{typography.font.size}"
	},
...
var r$27 = { root: { background: "light-dark(rgba(0,0,0,0.1), rgba(255,255,255,0.3))" } };
var a$15 = {
	root: {
		background: "{content.background}",
		borderColor: "{content.border.color}",
	...
	handle: { background: "{content.border.color}" },
	mask: { fadeSize: "40px" }
};
var s$4 = {
	root: { transitionDuration: "{transition.duration}" },
...
var p$1 = {
	...
	layout: { background: "light-dark({surface.50}, {surface.900})" },
	header: {
		padding: "0.5rem",
		gap: "0.5rem"
	},
	...
	groupAction: {
		...
		focusColor: "{navigation.item.icon.focus.color}",
		focusBackground: "{navigation.item.focus.background}",
		icon: { size: "{navigation.item.icon.size}" }
	},
	menu: { gap: "{navigation.list.gap}" },
	menuButton: {
...
var d$8 = {
	...
	steppanels: { padding: "0.75rem 0.5rem 1rem 0.5rem" },
	steppanel: {
		background: "{content.background}",
		color: "{content.color}",
		padding: "0",
...
var a$4 = {
	event: { minHeight: "4.375rem" },
	horizontal: { eventContent: { padding: "0.875rem 0" } },
	vertical: { eventContent: { padding: "0 0.875rem" } },
	eventMarker: {
		size: "1rem",
		borderRadius: "50%",
		borderWidth: "2px",
