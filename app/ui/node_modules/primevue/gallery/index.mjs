...
import GalleryStyle from 'primevue/gallery/style';
  ...
  beforeUnmount: function beforeUnmount() {
    ...
    if (typeof document !== 'undefined') {
      ...
      if (document.fullscreenElement === this.rootEl) {
        var _document$exitFullscr, _document, _document$exitFullscr2;
        (_document$exitFullscr = (_document = document).exitFullscreen) === null || _document$exitFullscr === void 0 || (_document$exitFullscr = _document$exitFullscr.call(_document)) === null || _document$exitFullscr === void 0 || (_document$exitFullscr2 = _document$exitFullscr["catch"]) === null || _document$exitFullscr2 === void 0 || _document$exitFullscr2.call(_document$exitFullscr, function () {});
      }
    }
  },
  methods: {
    ...
    setFullScreen: function setFullScreen(value) {
      ...
      var el = this.rootEl;
      if (!el) return;
      var isNativeFullscreen = document.fullscreenElement === el;
      if (value && !isNativeFullscreen) {
        var _el$requestFullscreen, _el$requestFullscreen2;
        (_el$requestFullscreen = el.requestFullscreen) === null || _el$requestFullscreen === void 0 || (_el$requestFullscreen = _el$requestFullscreen.call(el)) === null || _el$requestFullscreen === void 0 || (_el$requestFullscreen2 = _el$requestFullscreen["catch"]) === null || _el$requestFullscreen2 === void 0 || _el$requestFullscreen2.call(_el$requestFullscreen, function () {});
      } else if (!value && document.fullscreenElement) {
        var _document$exitFullscr3, _document2, _document$exitFullscr4;
        (_document$exitFullscr3 = (_document2 = document).exitFullscreen) === null || _document$exitFullscr3 === void 0 || (_document$exitFullscr3 = _document$exitFullscr3.call(_document2)) === null || _document$exitFullscr3 === void 0 || (_document$exitFullscr4 = _document$exitFullscr3["catch"]) === null || _document$exitFullscr4 === void 0 || _document$exitFullscr4.call(_document$exitFullscr3, function () {});
      }
    },
    ...
    onDocumentFullscreenChange: function onDocumentFullscreenChange() {
      var _this2 = this;
      var active = typeof document !== 'undefined' && document.fullscreenElement === this.rootEl;
