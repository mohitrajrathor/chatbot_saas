...
import { toRaw, resolveComponent, resolveDirective, openBlock, createBlock, withCtx, createVNode, Transition, mergeProps, withDirectives, createElementBlock, renderSlot, Fragment, resolveDynamicComponent, normalizeClass, createCommentVNode, createElementVNode, toDisplayString, createTextVNode } from 'vue';
      ...
      return [createVNode(Transition, mergeProps({
        ...
        "default": withCtx(function () {
          ...
          return [$data.visible ? withDirectives((openBlock(), createElementBlock("div", mergeProps({
            ...
            key: 1,
            message: $data.confirmation,
            icon: $data.confirmation.icon ? $options.resolveIcon($data.confirmation.icon) : undefined
          }, null, 8, ["message", "icon"])), createElementVNode("div", mergeProps({
            ...
            "default": withCtx(function () {
              return [$options.rejectIcon || _ctx.$slots.rejecticon ? renderSlot(_ctx.$slots, "rejecticon", {
                key: 0
              }, function () {
                return [createElementVNode("span", mergeProps({
                  "class": $options.rejectIcon
                }, _ctx.ptm('pcRejectButton')['icon'], {
                  "data-pc-section": "rejectbuttonicon"
                }), null, 16)];
              }) : createCommentVNode("", true), createTextVNode(" " + toDisplayString($options.rejectLabel), 1)];
            }),
            _: 3
          }, 16, ["class", "autofocus", "unstyled", "size", "text", "onKeydown", "pt"]), createVNode(_component_Button, mergeProps({
            ...
            "default": withCtx(function () {
              return [$options.acceptIcon || _ctx.$slots.accepticon ? renderSlot(_ctx.$slots, "accepticon", {
                key: 0
              }, function () {
                return [createElementVNode("span", mergeProps({
                  "class": $options.acceptIcon
                }, _ctx.ptm('pcAcceptButton')['icon'], {
                  "data-pc-section": "acceptbuttonicon"
                }), null, 16)];
              }) : createCommentVNode("", true), createTextVNode(" " + toDisplayString($options.acceptLabel), 1)];
            }),
            _: 3
          }, 16, ["class", "autofocus", "unstyled", "size", "onKeydown", "pt"])], 16)], 64))], 16, _hoisted_1)), [[_directive_focustrap]]) : createCommentVNode("", true)];
        }),
        _: 3
