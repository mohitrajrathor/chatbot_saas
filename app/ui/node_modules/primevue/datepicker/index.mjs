...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("span", mergeProps({
  ...
  }, null, 8, ["id", "class", "style", "defaultValue", "placeholder", "name", "size", "invalid", "variant", "fluid", "required", "unstyled", "aria-expanded", "aria-controls", "aria-labelledby", "aria-label", "disabled", "readonly", "onInput", "onClick", "onFocus", "onBlur", "onKeydown", "data-p-has-dropdown", "data-p-has-e-icon", "pt"])) : createCommentVNode("", true), $options.isClearIconVisible && !_ctx.inline ? renderSlot(_ctx.$slots, "clearicon", {
    key: 1,
    ...
    return [createElementVNode("button", mergeProps({
      ...
      return [(openBlock(), createBlock(resolveDynamicComponent(_ctx.icon ? 'span' : 'Calendar'), mergeProps({
        "class": _ctx.icon
    ...
    return [(openBlock(), createBlock(resolveDynamicComponent(_ctx.icon ? 'i' : 'Calendar'), mergeProps({
          ...
          return [_ctx.inline || $data.overlayVisible ? (openBlock(), createElementBlock("div", mergeProps({
              ...
              return [withDirectives(createVNode(_component_Button, mergeProps({
                ...
                "default": withCtx(function () {
                  return [renderSlot(_ctx.$slots, "previcon", {}, function () {
                    return [(openBlock(), createBlock(resolveDynamicComponent(_ctx.prevIcon ? 'span' : 'ChevronLeft'), mergeProps({
                      "class": _ctx.prevIcon
                    }, {
                      ref_for: true
              ...
              return [withDirectives(createVNode(_component_Button, mergeProps({
                ...
                "default": withCtx(function () {
                  return [renderSlot(_ctx.$slots, "nexticon", {}, function () {
                    return [(openBlock(), createBlock(resolveDynamicComponent(_ctx.nextIcon ? 'span' : 'ChevronRight'), mergeProps({
                      "class": _ctx.nextIcon
                    }, {
                      ref_for: true
            ...
            return [createVNode(_component_Button, mergeProps({
              ...
              "default": withCtx(function () {
                return [renderSlot(_ctx.$slots, "incrementicon", {}, function () {
                  return [(openBlock(), createBlock(resolveDynamicComponent(_ctx.incrementIcon ? 'span' : 'ChevronUp'), mergeProps({
            ...
            return [createVNode(_component_Button, mergeProps({
              ...
              "default": withCtx(function () {
                return [renderSlot(_ctx.$slots, "decrementicon", {}, function () {
                  return [(openBlock(), createBlock(resolveDynamicComponent(_ctx.decrementIcon ? 'span' : 'ChevronDown'), mergeProps({
            ...
            return [renderSlot(_ctx.$slots, "todaybutton", {
              ...
              return [createVNode(_component_Button, mergeProps({
                ...
                "default": withCtx(function () {
                  return [createTextVNode(toDisplayString($options.todayLabel), 1)];
                }),
                _: 1
              }, 16, ["class", "unstyled", "onKeydown", "pt"])];
              ...
              return [createVNode(_component_Button, mergeProps({
                ...
                "default": withCtx(function () {
                  return [createTextVNode(toDisplayString($options.clearLabel), 1)];
                }),
                _: 1
              }, 16, ["class", "unstyled", "onKeydown", "pt"])];
            })];
