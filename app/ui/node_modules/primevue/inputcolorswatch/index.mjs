...
import InputColorSwatchStyle from 'primevue/inputcolorswatch/style';

var script$1 = {
  name: 'BaseInputColorSwatch',
  ...
  style: InputColorSwatchStyle,
  provide: function provide() {
    return {
      $pcInputColorSwatch: this,
      $parentInstance: this
    };
  }
};
...
var script = {
  ...
  components: {
    ...
    InputColorSwatchBackground: InputColorSwatchBackground
  },
  computed: {
    swatchStyles: function swatchStyles() {
      return this.$pcInputColor.swatchStyles;
    },
