...
import { isTouchDevice, absolutePosition, getOuterWidth, addStyle, find, findSingle, focus } from '@primeuix/utils/dom';
...
var _hoisted_1$2 = ["id", "aria-label", "aria-disabled", "aria-haspopup", "aria-expanded", "aria-level", "aria-posinset", "aria-setsize", "data-focused", "data-disabled", "data-toggleable", "data-depth", "data-p"];
...
function render$2(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return $options.visible() ? (openBlock(), createElementBlock("li", mergeProps({
    ...
    "aria-haspopup": $props.toggleable ? 'true' : undefined,
    "aria-expanded": $props.toggleable ? $props.expanded : undefined,
    ...
    "data-depth": $props.toggleable ? $props.depth : undefined,
    ...
    "data-p": $options.dataP
  }, $options.getPTOptions('itemLabel')), toDisplayString($options.label()), 17, _hoisted_5), $props.toggleable ? (openBlock(), createElementBlock(Fragment, {
    key: 3
  }, [$props.templates && $props.templates.submenuicon ? (openBlock(), createBlock(resolveDynamicComponent($props.templates.submenuicon), {
    key: 0,
    item: $props.item,
    "class": normalizeClass(_ctx.cx('itemSubmenuIcon')),
    "data-expanded": $props.expanded || undefined
  }, null, 8, ["item", "class", "data-expanded"])) : (openBlock(), createBlock(_component_ChevronDownIcon, mergeProps({
    key: 1,
    "class": _ctx.cx('itemSubmenuIcon'),
    "data-expanded": $props.expanded || undefined
  }, $options.getPTOptions('itemSubmenuIcon')), null, 16, ["class", "data-expanded"]))], 64)) : createCommentVNode("", true)], 16, _hoisted_3)), [[_directive_ripple]]) : $props.templates.item ? (openBlock(), createBlock(resolveDynamicComponent($props.templates.item), {
    key: 1,
    item: $props.item,
    label: $options.label(),
    icon: $props.item.icon ? $options.resolveIcon($props.item.icon) : undefined,
    props: $options.getMenuItemProps($props.item)
  }, null, 8, ["item", "label", "icon", "props"])) : createCommentVNode("", true)], 16, _hoisted_2$1), $props.toggleable && $props.expanded ? (openBlock(), createElementBlock("ul", mergeProps({
    key: 0,
...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(true), createElementBlock(Fragment, null, renderList($props.items, function (item, i) {
    return openBlock(), createElementBlock(Fragment, {
      key: $options.itemId(item, i)
    }, [item.separator && $options.visible(item) ? (openBlock(), createElementBlock("li", mergeProps({
      key: 0,
      ...
      ref_for: true
    }, _ctx.ptm('separator')), null, 16)) : item.items && $options.visible(item) && !$options.toggleable(item) ? (openBlock(), createElementBlock(Fragment, {
      key: 1
      ...
      ref_for: true
    }, _ctx.ptm('submenuLabel')), [$props.templates && $props.templates.submenulabel ? (openBlock(), createBlock(resolveDynamicComponent($props.templates.submenulabel), {
      key: 0,
      item: item
    }, null, 8, ["item"])) : (openBlock(), createElementBlock(Fragment, {
      key: 1
    }, [createTextVNode(toDisplayString($options.label(item)), 1)], 64))], 16, _hoisted_1$1), createVNode(_component_MenuSub, {
      items: item.items,
      depth: $props.depth + 1,
      ...
      pt: _ctx.pt
    }, null, 8, ["items", "depth", "parentId", "templates", "focusedOptionId", "unstyled", "pt"])], 64)) : $options.visible(item) && !item.separator ? (openBlock(), createBlock(_component_Menuitem, {
      key: 2,
      id: $options.itemId(item, i),
      item: item,
      index: i,
      ...
      _: 2
    }, [!!item.items && $options.toggleable(item) ? {
      name: "submenu",
      fn: withCtx(function () {
        return [createVNode(_component_MenuSub, {
          ...
          pt: _ctx.pt
        }, null, 8, ["items", "depth", "parentId", "templates", "focusedOptionId", "unstyled", "pt"])];
      }),
      key: "0"
    } : undefined]), 1032, ["id", "item", "index", "templates", "focusedOptionId", "toggleable", "expanded", "depth", "unstyled", "pt"])) : createCommentVNode("", true)], 64);
  }), 128);
}
...
var script = {
  ...
  methods: {
    ...
    onEnterKey: function onEnterKey(event) {
      event.preventDefault();
      var element = findSingle(this.list, "[id=\"".concat(this.focusedOptionId, "\"]"));
      if (!element) return;
      if (element.getAttribute('data-toggleable') === 'true') {
        var content = findSingle(element, '[data-pc-section="itemcontent"]') || element;
        content.click();
        return;
      }
      var anchorElement = findSingle(element, 'a[data-pc-section="itemlink"]');
    ...
    findNextOptionIndex: function findNextOptionIndex(id) {
      var links = find(this.container, FOCUSABLE_SELECTOR);
    ...
    isItemToggleable: function isItemToggleable(item, depth) {
      return (item === null || item === void 0 ? void 0 : item.toggleable) !== undefined ? item.toggleable : depth > 0;
    },
    ...
    toggleSubmenu: function toggleSubmenu(id) {
      ...
      if (this.expandedKeys !== undefined) this.$emit('update:expandedKeys', next);else this.d_expandedKeys = next;
    },
    ...
    ariaMetaMap: function ariaMetaMap() {
      ...
      var _collectSiblings = function collectSiblings(items, depth) {
        ...
        (items || []).forEach(function (item) {
          ...
          if (item.items && !_this4.isItemToggleable(item, depth)) {
            siblings.push.apply(siblings, _toConsumableArray(_collectSiblings(item.items, depth + 1)));
          } else {
            siblings.push(item);
          }
        });
      ...
      var _assign = function assign(items, level, depth) {
        ...
        siblings.forEach(function (item, idx) {
          ...
          if (item.items) {
            _assign(item.items, level + 1, depth + 1);
          }
        });
      };
      ...
      return [createVNode(Transition, mergeProps({
        ...
        "default": withCtx(function () {
          return [(_ctx.popup ? $data.overlayVisible : true) ? (openBlock(), createElementBlock("div", mergeProps({
            ...
            "aria-activedescendant": $data.focused ? $data.focusedOptionId : undefined,
            ...
            pt: _ctx.pt
          }, null, 8, ["items", "parentId", "templates", "focusedOptionId", "unstyled", "onItemClick", "onItemMousemove", "pt"])], 16, _hoisted_2), _ctx.$slots.end ? (openBlock(), createElementBlock("div", mergeProps({
            key: 1,
            "class": _ctx.cx('end')
