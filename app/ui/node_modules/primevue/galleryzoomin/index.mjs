...
var script$1 = {
  ...
  style: GalleryZoomInStyle,
  provide: function provide() {
    return {
      $pcGalleryZoomIn: this,
      $parentInstance: this
    };
  }
};
...
var script = {
  ...
  methods: {
    onClick: function onClick() {
      var _this$$pcGallery;
      (_this$$pcGallery = this.$pcGallery) === null || _this$$pcGallery === void 0 || _this$$pcGallery.onClickAction('zoomIn');
    }
  },
  computed: {
