<template>
    <div :class="cx('filter')" v-bind="getColumnPT('filter')">
        ...
        >
            <component :is="filterIconTemplate || (hasFilter() ? 'FilterFill' : 'Filter')" v-bind="getColumnPT('filterMenuIcon')" />
        </Button>
        <Portal>
                ...
                >
                    ...
                    <template v-if="display === 'row'">
                        <ul :class="cx('filterConstraintList')" v-bind="getColumnPT('filterConstraintList')">
                            ...
                            <li :class="cx('filterConstraint')" @click="clearFilter()" @keydown="onRowMatchModeKeyDown($event)" @keydown.enter.prevent="clearFilter()" v-bind="getColumnPT('filterConstraint')">
                                {{ noFilterLabel }}
                            </li>
                        </ul>
                    </template>
                    <template v-else>
                            ...
                            <div v-for="(fieldConstraint, i) of fieldConstraints" :key="i" :class="cx('filterRule')" v-bind="getColumnPT('filterRule')">
                                ...
                                <div v-if="showRemoveIcon" v-bind="getColumnPT('filterRemove')">
                                    <Button
                                        ...
                                        :aria-label="removeRuleButtonLabel"
                                        @click="removeConstraint(i)"
                                        :unstyled="unstyled"
                                        v-bind="filterButtonProps.popover.removeRule"
                                        :pt="getColumnPT('pcFilterRemoveRuleButton')"
                                    >
                                        <component :is="filterRemoveIconTemplate || 'Trash'" v-bind="getColumnPT('pcFilterRemoveRuleButton')['icon']" />
                                    </Button>
                                </div>
                            </div>
                        </div>
                        <div v-if="isShowAddConstraint" v-bind="getColumnPT('filterAddButtonContainer')">
                            <Button type="button" :class="cx('pcFilterAddRuleButton')" @click="addConstraint()" :unstyled="unstyled" v-bind="filterButtonProps.popover.addRule" :pt="getColumnPT('pcFilterAddRuleButton')">
                                <component :is="filterAddIconTemplate || 'Plus'" v-bind="getColumnPT('pcFilterAddRuleButton')['icon']" />
                                {{ addRuleButtonLabel }}
                            </Button>
                        </div>
                        <div :class="cx('filterButtonbar')" v-bind="getColumnPT('filterButtonbar')">
                            ...
                            <template v-if="showApplyButton">
                                <Button v-if="!filterApplyTemplate" type="button" :class="cx('pcFilterApplyButton')" @click="applyFilter()" :unstyled="unstyled" v-bind="filterButtonProps.popover.apply" :pt="getColumnPT('pcFilterApplyButton')">{{
                                    applyButtonLabel
                                }}</Button>
