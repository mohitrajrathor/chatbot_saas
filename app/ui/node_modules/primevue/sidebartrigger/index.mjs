...
import SidebarTriggerStyle from 'primevue/sidebartrigger/style';
...
var script = {
  ...
  computed: {
    a11yAttrs: function a11yAttrs() {
      ...
      var sidebarPart = (_this$$pcSidebar$getS = (_this$$pcSidebar = this.$pcSidebar) === null || _this$$pcSidebar === void 0 ? void 0 : _this$$pcSidebar.getSectionAttrs('trigger')) !== null && _this$$pcSidebar$getS !== void 0 ? _this$$pcSidebar$getS : {};
