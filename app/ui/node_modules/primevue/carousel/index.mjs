...
import { isElement, setAttribute, find, findSingle, getAttribute, addClass, removeClass } from '@primeuix/utils/dom';
...
var script = {
  ...
  updated: function updated() {
    if (!this.hasCarouselValue) return;
    if (this.$refs.itemsContainer && !this.carouselStyle) {
      this.initializeLegacyCarousel();
    }
    if (!this.empty) {
  ...
  methods: {
    initializeLegacyCarousel: function initializeLegacyCarousel() {
      ...
      if (this.responsiveOptions && !this.documentResizeListener) {
    ...
    updateNavigationState: function updateNavigationState() {
      var page = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : this.d_page;
    ...
    onTouchMove: function onTouchMove(e) {
      ...
      if (Math.abs(diff) > SWIPE_THRESHOLD && e.cancelable) {
        e.preventDefault();
      }
    },
    ...
    computeSnapPoints: function computeSnapPoints() {
      ...
      content.querySelectorAll('[data-pc-name="carouselitem"]').forEach(function (item) {
        ...
        if (_this5.align === 'center') {
          snapPoint = offset - (trackSize - size) / 2;
        } else if (_this5.align === 'end') {
    ...
    setPage: function setPage(page) {
      var slideOverride = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
      this.updateNavigationState(page);
      this.d_page = page;
      this.$emit('update:page', page);
    ...
    onContentPointerMove: function onContentPointerMove(e) {
      ...
      if (distance < POINTER_SWIPE_DISTANCE) return;
    ...
    onContentPointerUp: function onContentPointerUp(e) {
      ...
      requestAnimationFrame(function () {
        if (closestSnapPoint !== undefined) _this6.scrollToPage(index);
        requestAnimationFrame(function () {
    ...
    bindContentScrollListener: function bindContentScrollListener() {
      ...
      this.contentEl.addEventListener('scroll', this.onScrollHandler, {
        passive: true
      });
    },
    unbindContentScrollListener: function unbindContentScrollListener() {
      ...
      if (this.contentEl && this.onScrollHandler) {
        this.contentEl.removeEventListener('scroll', this.onScrollHandler);
      }
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createBlock(resolveDynamicComponent(_ctx.as), mergeProps({
    ...
    "data-autosize": _ctx.autoSize ? '' : undefined,
    role: "region"
  }, _ctx.ptmi('root')), {
    "default": withCtx(function () {
      return [$options.hasCarouselValue ? (openBlock(), createElementBlock(Fragment, {
        key: 0
      ...
      }, _ctx.ptm('footer')), [renderSlot(_ctx.$slots, "footer")], 16)) : createCommentVNode("", true)], 64)) : renderSlot(_ctx.$slots, "default", {
        key: 1
      })];
    }),
    _: 3
  }, 16, ["class", "style", "data-orientation", "data-align", "data-page", "data-swiping", "data-autosize"]);
}
