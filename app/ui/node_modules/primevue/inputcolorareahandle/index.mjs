...
import InputColorAreaHandleStyle from 'primevue/inputcolorareahandle/style';
...
var script = {
  ...
  computed: {
    ...
    a11yAttrs: function a11yAttrs() {
      var _this$$pcInputColor$a = this.$pcInputColor.areaAxes,
        xChannel = _this$$pcInputColor$a.xChannel,
        yChannel = _this$$pcInputColor$a.yChannel;
