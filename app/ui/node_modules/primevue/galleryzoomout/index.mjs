...
var script$1 = {
  ...
  style: GalleryZoomOutStyle,
  provide: function provide() {
    return {
      $pcGalleryZoomOut: this,
      $parentInstance: this
    };
  }
};
...
var script = {
  ...
  methods: {
    onClick: function onClick() {
      var _this$$pcGallery;
      (_this$$pcGallery = this.$pcGallery) === null || _this$$pcGallery === void 0 || _this$$pcGallery.onClickAction('zoomOut');
    }
  },
  computed: {
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return !_ctx.asChild ? (openBlock(), createBlock(resolveDynamicComponent(_ctx.as), mergeProps({
    ...
    disabled: !$options.zoomed || undefined,
    ...
    _: 3
  }, 16, ["class", "type", "disabled", "onClick"])) : renderSlot(_ctx.$slots, "default", {
    key: 1,
    "class": normalizeClass(_ctx.cx('root')),
    onClick: $options.onClick,
    disabled: !$options.zoomed
  });
}
