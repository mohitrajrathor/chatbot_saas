...
import { isString, isNotEmpty, resolve, findLastIndex, isEmpty, isPrintableCharacter } from '@primeuix/utils/object';
...
import { toRaw, mergeProps, resolveComponent, resolveDirective, openBlock, createBlock, Transition, withCtx, createElementBlock, Fragment, renderList, createElementVNode, withDirectives, resolveDynamicComponent, normalizeClass, createCommentVNode, toDisplayString, createVNode, renderSlot } from 'vue';
...
var script$1 = {
  ...
  computed: {
    mobileActive: function mobileActive() {
      var _this$$pcTieredMenu;
      return !!((_this$$pcTieredMenu = this.$pcTieredMenu) !== null && _this$$pcTieredMenu !== void 0 && _this$$pcTieredMenu.queryMatches);
    }
  },
  components: {
    ...
    "default": withCtx(function () {
      return [($props.level === 0 ? true : $props.visible) ? (openBlock(), createElementBlock("ul", {
        ...
        return openBlock(), createElementBlock(Fragment, {
          ...
          ref_for: true
        }, $options.getPTOptions(processedItem, index, 'itemIcon')), null, 16, ["class"])) : $options.getItemProp(processedItem, 'icon') ? (openBlock(), createElementBlock("span", mergeProps({
          key: 2,
          ...
          ref_for: true
        }, $options.getPTOptions(processedItem, index, 'submenuIcon')), null, 16, ["class", "active"])) : (openBlock(), createBlock(_component_AngleRight, mergeProps({
          key: 1,
          "class": _ctx.cx('submenuIcon')
        }, {
          ref_for: true
        ...
        }, null, 8, ["item", "hasSubmenu", "label", "icon", "props"]))], 16, _hoisted_3), $options.isItemVisible(processedItem) && $options.isItemGroup(processedItem) ? (openBlock(), createBlock(_component_TieredMenuSub, mergeProps({
          key: 0,
