...
import { isString, isNotEmpty, resolve, isEmpty, findLast, isPrintableCharacter, equals } from '@primeuix/utils/object';
import { toRaw, mergeProps, resolveComponent, resolveDirective, openBlock, createElementBlock, normalizeClass, Fragment, renderList, createElementVNode, withDirectives, createBlock, resolveDynamicComponent, createCommentVNode, toDisplayString, createVNode, Transition, withCtx, vShow, renderSlot } from 'vue';
  ...
  methods: {
    ...
    getMenuItemProps: function getMenuItemProps(processedItem, index) {
      return {
        ...
        icon: mergeProps({
          "class": [this.cx('itemIcon'), isString(this.getItemProp(processedItem, 'icon')) ? this.getItemProp(processedItem, 'icon') : undefined]
...
function render$2(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("ul", {
    ...
    return openBlock(), createElementBlock(Fragment, {
      ...
      ref_for: true
    }, $options.getPTOptions('submenuIcon', processedItem, index)), null, 16, ["class", "active"])) : (openBlock(), createBlock(resolveDynamicComponent($options.isItemActive(processedItem) ? 'ChevronDown' : 'ChevronRight'), mergeProps({
      key: 1,
      "class": _ctx.cx('submenuIcon')
    }, {
      ref_for: true
      ...
      ref_for: true
    }, $options.getPTOptions('itemIcon', processedItem, index)), null, 16, ["class"])) : $options.getItemProp(processedItem, 'icon') ? (openBlock(), createElementBlock("span", mergeProps({
      key: 3,
      ...
      key: 1,
      item: processedItem.item,
      icon: $options.getItemProp(processedItem, 'icon') ? $options.resolveIcon($options.getItemProp(processedItem, 'icon')) : undefined,
      root: false,
      active: $options.isItemActive(processedItem),
      hasSubmenu: $options.isItemGroup(processedItem),
      label: $options.getItemLabel(processedItem),
      props: $options.getMenuItemProps(processedItem, index)
    }, null, 8, ["item", "icon", "active", "hasSubmenu", "label", "props"]))], 16, _hoisted_3$1), createVNode(Transition, mergeProps({
      name: "p-collapsible"
    }, {
      ref_for: true
    }, _ctx.ptm('transition')), {
...
var script = {
  ...
  methods: {
    ...
    getMenuItemProps: function getMenuItemProps(item, index) {
      return {
        icon: mergeProps({
          "class": [this.cx('headerIcon'), isString(this.getItemProp(item, 'icon')) ? this.getItemProp(item, 'icon') : undefined]
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", mergeProps({
    ...
    return openBlock(), createElementBlock(Fragment, {
      ...
      return [(openBlock(), createBlock(resolveDynamicComponent($options.isItemActive(item) ? 'ChevronDown' : 'ChevronRight'), mergeProps({
        "class": _ctx.cx('submenuIcon')
      }, {
        ref_for: true
      ...
      key: 1,
      item: item,
      "class": normalizeClass(_ctx.cx('headerIcon'))
    }, null, 8, ["item", "class"])) : $options.isComponentIcon($options.getItemProp(item, 'icon')) ? (openBlock(), createBlock(resolveDynamicComponent($options.resolveIcon($options.getItemProp(item, 'icon'))), mergeProps({
      key: 2,
      "class": _ctx.cx('headerIcon')
    }, {
      ref_for: true
    }, $options.getPTOptions('headerIcon', item, index)), null, 16, ["class"])) : $options.getItemProp(item, 'icon') ? (openBlock(), createElementBlock("span", mergeProps({
      key: 3,
      ...
      key: 1,
      item: item,
      icon: $options.getItemProp(item, 'icon') ? $options.resolveIcon($options.getItemProp(item, 'icon')) : undefined,
      root: true,
      active: $options.isItemActive(item),
      hasSubmenu: $options.isItemGroup(item),
      label: $options.getItemLabel(item),
      props: $options.getMenuItemProps(item, index)
    }, null, 8, ["item", "icon", "active", "hasSubmenu", "label", "props"]))], 16)], 16, _hoisted_2), createVNode(Transition, mergeProps({
      name: "p-collapsible"
    }, {
      ref_for: true
    }, _ctx.ptm('transition')), {
