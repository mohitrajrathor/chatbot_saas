...
import CarouselContentStyle from 'primevue/carouselcontent/style';
...
var script = {
  ...
  inject: ['$pcCarousel'],
  methods: {
    setContentElRef: function setContentElRef(el) {
  ...
  computed: {
    ...
    a11yAttrs: function a11yAttrs() {
      ...
      return {
        ...
        'data-swiping': (_this$$pcCarousel5 = this.$pcCarousel) !== null && _this$$pcCarousel5 !== void 0 && _this$$pcCarousel5.swiping ? '' : undefined,
        'data-autosize': (_this$$pcCarousel6 = this.$pcCarousel) !== null && _this$$pcCarousel6 !== void 0 && _this$$pcCarousel6.autoSize ? '' : undefined,
