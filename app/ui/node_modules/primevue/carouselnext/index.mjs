...
import CarouselNextStyle from 'primevue/carouselnext/style';

var script$1 = {
  name: 'BaseCarouselNext',
...
var script = {
  ...
  computed: {
    effectiveDisabled: function effectiveDisabled() {
      ...
      return this.disabled || !!((_this$$pcCarousel = this.$pcCarousel) !== null && _this$$pcCarousel !== void 0 && _this$$pcCarousel.isNextDisabled);
    },
    ...
    a11yAttrs: function a11yAttrs() {
      ...
      return {
        'aria-label': (_this$$pcCarousel2 = this.$pcCarousel) === null || _this$$pcCarousel2 === void 0 ? void 0 : _this$$pcCarousel2.ariaNextButtonLabel,
        ...
        onClick: (_this$$pcCarousel7 = this.$pcCarousel) === null || _this$$pcCarousel7 === void 0 ? void 0 : _this$$pcCarousel7.next
      };
    }
  }
};
