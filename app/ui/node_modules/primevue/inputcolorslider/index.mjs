...
import InputColorSliderStyle from 'primevue/inputcolorslider/style';
...
var script = {
  ...
  methods: {
    ...
    onSliderKeyDown: function onSliderKeyDown(event) {
      ...
      var allowed = isVertical ? ['ArrowUp', 'ArrowDown'] : ['ArrowLeft', 'ArrowRight'];
      if (!allowed.includes(event.key)) return;
      event.preventDefault();
      var _this$range2 = this.range,
        step = _this$range2.step,
  ...
  computed: {
    ...
    cssVars: function cssVars() {
      var baseGradient = this.$pcInputColor.getChannelGradient(this.channel, this.orientation);
      var handleColor = this.$pcInputColor.getChannelColor(this.channel).toString('css');
      return {
  ...
  components: {
    InputColorTransparencyGrid: InputColorTransparencyGrid,
    InputColorSliderTrack: InputColorSliderTrack,
    InputColorSliderHandle: InputColorSliderHandle
  }
};
