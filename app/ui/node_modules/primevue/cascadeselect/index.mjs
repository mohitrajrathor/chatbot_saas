...
import { nestedPosition, findSingle, isTouchDevice, relativePosition, getOuterWidth, absolutePosition, addStyle, focus } from '@primeuix/utils/dom';
...
var script$1 = {
  ...
  methods: {
    ...
    positionNestedOverlay: function positionNestedOverlay() {
      if (this.container && this.level > 0 && !this.inline) {
...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("ul", mergeProps({
    ...
    return openBlock(), createElementBlock("li", mergeProps({
      ...
      ref_for: true
    }, $options.getPTOptions(processedOption, index, 'groupIcon')), null, 16)) : (openBlock(), createBlock(_component_AngleRight, mergeProps({
      key: 2,
    ...
    }, null, 8, ["class", "selectId", "focusedOptionId", "options", "activeOptionPath", "level", "templates", "optionLabel", "optionValue", "optionDisabled", "optionGroupIcon", "optionGroupLabel", "optionGroupChildren", "value", "inline", "pt", "unstyled"])) : createCommentVNode("", true)], 16, _hoisted_1$1);
  }), 128))], 16);
}
    ...
    "default": withCtx(function () {
      return [createVNode(Transition, mergeProps({
        ...
        "default": withCtx(function () {
          return [$data.overlayVisible ? (openBlock(), createElementBlock("div", mergeProps({
          ...
          }, _objectSpread(_objectSpread({}, _ctx.overlayProps), _ctx.ptm('overlay'))), [renderSlot(_ctx.$slots, "header", {
            value: _ctx.d_value,
            ...
            pt: _ctx.pt,
            unstyled: _ctx.unstyled
          }, null, 8, ["id", "selectId", "focusedOptionId", "options", "activeOptionPath", "templates", "optionLabel", "optionValue", "optionDisabled", "optionGroupIcon", "optionGroupLabel", "optionGroupChildren", "value", "inline", "onOptionChange", "onOptionFocusChange", "onOptionFocusEnterChange", "pt", "unstyled"])], 16), createElementVNode("span", mergeProps({
            role: "status",
            "aria-live": "polite",
            "class": "p-hidden-accessible"
