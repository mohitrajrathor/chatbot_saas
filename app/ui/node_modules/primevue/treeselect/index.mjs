...
var script = {
  ...
  methods: {
    ...
    isOutsideClicked: function isOutsideClicked(event) {
      ...
      return !(composedPath.includes(this.$el) || this.overlay && composedPath.includes(this.overlay));
    },
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", mergeProps({
    ...
    return [(openBlock(), createBlock(resolveDynamicComponent('ChevronDown'), mergeProps({
