...
var script = {
  ...
  "extends": script$1,
  inheritAttrs: false,
  emits: ['click', 'show', 'hide', 'focus', 'blur', 'update:visible'],
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock(Fragment, null, [createElementVNode("div", mergeProps({
    ...
    return [createVNode(_component_Button, mergeProps({
      ...
      "default": withCtx(function () {
        return [renderSlot(_ctx.$slots, "icon", {
          ...
          }), null, 16, ["class"])) : (openBlock(), createBlock(resolveDynamicComponent(_ctx.showIcon ? 'span' : 'Plus'), mergeProps({
            key: 1,
    ...
    return openBlock(), createElementBlock(Fragment, {
      ...
      "default": withCtx(function () {
        return [item.icon ? renderSlot(_ctx.$slots, "itemicon", {
          key: 0,
          item: item
        }, function () {
          return [$options.isComponentIcon(item.icon) ? (openBlock(), createBlock(resolveDynamicComponent($options.resolveIcon(item.icon)), mergeProps({
            ...
            ref_for: true
          }, $options.getPTOptions("".concat(_ctx.$id, "_").concat(index), 'actionIcon')), null, 16)) : createCommentVNode("", true)];
        }) : createCommentVNode("", true)];
      }),
      _: 2
    }, 1040, ["class", "aria-label", "disabled", "unstyled", "onClick", "pt"])), [[_directive_tooltip, {
      value: item.label,
      disabled: !_ctx.tooltipOptions
    }, _ctx.tooltipOptions]]) : (openBlock(), createBlock(resolveDynamicComponent(_ctx.$slots.item), {
      key: 1,
      item: item,
      icon: item.icon ? $options.resolveIcon(item.icon) : undefined,
      onClick: function onClick(event) {
        return $options.onItemClick(event, item);
      },
    ...
    }, null, 8, ["item", "icon", "onClick", "toggleCallback"]))], 16, _hoisted_2)) : createCommentVNode("", true)], 64);
