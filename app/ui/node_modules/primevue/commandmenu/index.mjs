...
import CommandMenuStyle from 'primevue/commandmenu/style';
  ...
  methods: {
    ...
    scrollFocusedOptionInView: function scrollFocusedOptionInView() {
      ...
      requestAnimationFrame(function () {
        ...
        (_findSingle = findSingle(menu.list, "[id=\"".concat(_this2.focusedOptionId, "\"]"))) === null || _findSingle === void 0 || (_findSingle$scrollInt = _findSingle.scrollIntoView) === null || _findSingle$scrollInt === void 0 || _findSingle$scrollInt.call(_findSingle, {
          block: 'nearest',
          inline: 'nearest'
        });
      });
    ...
    wrapCommands: function wrapCommands(items) {
      ...
      return items.map(function (item) {
        return item.items ? _objectSpread(_objectSpread({}, item), {}, {
          items: _this4.wrapCommands(item.items)
        }) : _this4.wrapCommand(item);
      });
    },
      ...
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          ...
          if (item.items) {
            ...
            if (children.length) out.push(_objectSpread(_objectSpread({}, item), {}, {
              items: children
            }));
    ...
    scoreItem: function scoreItem(item, search) {
      var _this$filter;
      var scorer = (_this$filter = this.filter) !== null && _this$filter !== void 0 ? _this$filter : this.defaultScorer;
      return scorer(item, search) || 0;
    },
    defaultScorer: function defaultScorer(item, search) {
      if (!search) return 1;
      var s = String(search).toLowerCase();
      var label = String(this.resolveItemLabel(item)).toLowerCase();
      if (label.includes(s)) return 1;
      var kws = Array.isArray(item.keywords) ? item.keywords : item.keywords ? [item.keywords] : [];
      var _iterator2 = _createForOfIteratorHelper(kws),
        _step2;
      try {
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return !_ctx.asChild ? (openBlock(), createBlock(resolveDynamicComponent(_ctx.as), mergeProps({
    ...
    "default": withCtx(function () {
      return [createElementVNode("div", mergeProps({
      ...
      })], 16), $options.filteredModel.length === 0 ? (openBlock(), createElementBlock("div", mergeProps({
        key: 0,
        "class": _ctx.cx('emptyMessage')
      }, _ctx.ptm('emptyMessage')), [$options.isFiltering ? renderSlot(_ctx.$slots, "emptyfilter", {
        key: 0
      }, function () {
      ...
      })], 16)) : createCommentVNode("", true), createVNode(_component_Menu, {
        id: $options.menuId,
        ref: "menu",
        ...
        key: "0"
      } : undefined, _ctx.$slots.submenulabel ? {
        name: "submenulabel",
        fn: withCtx(function (slotProps) {
          return [renderSlot(_ctx.$slots, "submenulabel", normalizeProps(guardReactiveProps(slotProps)))];
        }),
        key: "1"
      } : undefined]), 1032, ["id", "model", "aria-label", "aria-labelledby", "class", "style", "pt", "unstyled"]), _ctx.$slots.footer ? (openBlock(), createElementBlock("div", mergeProps({
        key: 1,
        "class": _ctx.cx('footer')
      }, _ctx.ptm('footer')), [renderSlot(_ctx.$slots, "footer", {
        items: $options.filteredModel
