...
import { resolveComponent, openBlock, createElementBlock, Fragment, renderList, mergeProps, createElementVNode, toDisplayString, createVNode, normalizeClass, withCtx, createBlock, resolveDynamicComponent, renderSlot, withKeys, createTextVNode, createCommentVNode, normalizeProps } from 'vue';
    ...
    return openBlock(), createElementBlock("div", mergeProps({
      ...
      "default": withCtx(function () {
        return [$props.templates.fileremoveicon ? (openBlock(), createBlock(resolveDynamicComponent($props.templates.fileremoveicon), {
          ...
          file: file,
          index: index
        }, null, 8, ["file", "index"])) : (openBlock(), createBlock(_component_Times, mergeProps({
          key: 1,
          "aria-hidden": "true"
        }, {
          ref_for: true
        }, _ctx.ptm('pcFileRemoveButton')['icon']), null, 16))];
      }),
      _: 2
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return $options.isAdvanced ? (openBlock(), createElementBlock("div", mergeProps({
    ...
    return [createVNode(_component_Button, mergeProps({
      ...
      "default": withCtx(function () {
        return [renderSlot(_ctx.$slots, "chooseicon", {}, function () {
          return [(openBlock(), createBlock(resolveDynamicComponent(_ctx.chooseIcon ? 'span' : 'Plus'), mergeProps({
            "class": _ctx.chooseIcon,
            "aria-hidden": "true"
          }, _ctx.ptm('pcChooseButton')['icon']), null, 16, ["class"]))];
        }), createTextVNode(" " + toDisplayString($options.chooseButtonLabel), 1)];
      }),
      _: 3
    }, 16, ["class", "style", "disabled", "unstyled", "onClick", "onKeydown", "onFocus", "onBlur", "pt"]), _ctx.showUploadButton ? (openBlock(), createBlock(_component_Button, mergeProps({
      key: 0,
      ...
      "default": withCtx(function () {
        return [renderSlot(_ctx.$slots, "uploadicon", {}, function () {
          return [(openBlock(), createBlock(resolveDynamicComponent(_ctx.uploadIcon ? 'span' : 'Upload'), mergeProps({
            "class": _ctx.uploadIcon,
            "aria-hidden": "true"
          }, _ctx.ptm('pcUploadButton')['icon'], {
            "data-pc-section": "uploadbuttonicon"
          }), null, 16, ["class"]))];
        }), createTextVNode(" " + toDisplayString($options.uploadButtonLabel), 1)];
      }),
      _: 3
    }, 16, ["class", "onClick", "disabled", "unstyled", "pt"])) : createCommentVNode("", true), _ctx.showCancelButton ? (openBlock(), createBlock(_component_Button, mergeProps({
      key: 1,
      ...
      "default": withCtx(function () {
        return [renderSlot(_ctx.$slots, "cancelicon", {}, function () {
          return [(openBlock(), createBlock(resolveDynamicComponent(_ctx.cancelIcon ? 'span' : 'Times'), mergeProps({
            "class": _ctx.cancelIcon,
            "aria-hidden": "true"
          }, _ctx.ptm('pcCancelButton')['icon'], {
            "data-pc-section": "cancelbuttonicon"
          }), null, 16, ["class"]))];
        }), createTextVNode(" " + toDisplayString($options.cancelButtonLabel), 1)];
      }),
      _: 3
    }, 16, ["class", "onClick", "disabled", "unstyled", "pt"])) : createCommentVNode("", true)];
    ...
    _: 3
  }, 16, ["class", "style", "disabled", "unstyled", "onMouseup", "onKeydown", "onFocus", "onBlur", "pt"]), !_ctx.auto ? renderSlot(_ctx.$slots, "filelabel", {
    key: 0,
