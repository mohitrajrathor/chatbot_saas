...
var script$1 = {
  ...
  style: SidebarGroupActionStyle,
  provide: function provide() {
    return {
      $pcSidebarGroupAction: this,
      $parentInstance: this
    };
  }
};
