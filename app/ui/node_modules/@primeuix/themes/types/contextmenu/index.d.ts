...
export declare namespace ContextMenuTokenSections {
    ...
    interface SubmenuLabel {
         ...
         *
         * @designToken contextmenu.submenu.label.padding
         */
        padding?: string;
        /**
         * Font weight of submenu label
         *
         * @designToken contextmenu.submenu.label.font.weight
         */
        fontWeight?: string;
        /**
         * Font size of submenu label
         *
         * @designToken contextmenu.submenu.label.font.size
         */
        fontSize?: string;
        /**
         * Background of submenu label
         *
         * @designToken contextmenu.submenu.label.background
         */
        background?: string;
        /**
         * Color of submenu label
         *
         * @designToken contextmenu.submenu.label.color
         */
        color?: string;
    }
...
export interface ContextMenuDesignTokens extends DesignTokens<ContextMenuDesignTokens> {
     ...
     */
    submenuLabel?: ContextMenuTokenSections.SubmenuLabel;
    /**
