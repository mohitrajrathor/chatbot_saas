...
export declare namespace OrganizationChartTokenSections {
    ...
    interface Node {
         ...
         * Font size of node
         *
         * @designToken organizationchart.node.font.size
         */
        fontSize?: string;
        /**
         * Font weight of node
         *
         * @designToken organizationchart.node.font.weight
         */
        fontWeight?: string;
        /**
         * Focus ring of node
        ...
        focusRing?: {
             ...
             *
             * @designToken organizationchart.node.focus.ring.width
             */
            width?: string;
            /**
             * Focus ring style of node
             *
             * @designToken organizationchart.node.focus.ring.style
             */
            style?: string;
            /**
             * Focus ring color of node
             *
             * @designToken organizationchart.node.focus.ring.color
             */
            color?: string;
            /**
             * Focus ring offset of node
             *
             * @designToken organizationchart.node.focus.ring.offset
             */
            offset?: string;
            /**
             * Focus ring shadow of node
             *
             * @designToken organizationchart.node.focus.ring.shadow
             */
            shadow?: string;
        };
    }
    ...
    interface NodeToggleButton {
        ...
        /**
         * Icon of node toggle button
         */
        icon?: {
            /**
             * Icon size of node toggle button
             *
             * @designToken organizationchart.node.toggle.button.icon.size
             */
            size?: string;
        };
    }
