...
export declare namespace MenuTokenSections {
    ...
    interface SubmenuIcon {
         ...
         *
         * @designToken menu.submenu.icon.size
         */
        size?: string;
        /**
         * Color of submenu icon
         *
         * @designToken menu.submenu.icon.color
         */
        color?: string;
        /**
         * Focus color of submenu icon
         *
         * @designToken menu.submenu.icon.focus.color
         */
        focusColor?: string;
    }
...
export interface MenuDesignTokens extends DesignTokens<MenuDesignTokens> {
     ...
     */
    submenuIcon?: MenuTokenSections.SubmenuIcon;
    /**
